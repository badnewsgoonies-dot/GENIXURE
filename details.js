...
window.HEIC_DETAILS = {
  ...
  "items/arcane_bell": {
    ...
    "effects": [
      {
        "action": "decrease_all_countdowns",
        "trigger": "battleStart",
        "value": 1
      }
    ],
  ...
  "items/arcane_cloak": {
    ...
    "effects": [
      {
        "event": "postCountdownTrigger",
        "actions": [
          {
            "type": "reset_countdown_on_trigger"
          }
        ]
      }
    ]
  ...
  "items/arcane_shield": {
    ...
    "effects": [
      {
        "event": "onCountdownTrigger",
        "actions": [
          {
            "type": "add_armor_on_countdown",
            "value": 3
          }
        ]
      }
  ...
  "items/bramble_buckler": {
    ...
    "effects": [
      {
        "action": "convert_armor_to_thorns",
        "if": {
          "type": "has_armor"
        },
        "trigger": "turnStart",
    ...
    "effects": [
      {
        ...
        "actions": [
          {
            "type": "damage_enemy_if_exposed",
            "value": 4
          },
          {
            "type": "reduce_speed_on_battle_start",
            "value": 1
          }
        ]
      },
