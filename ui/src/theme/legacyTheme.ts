...
export const outline = 'rounded-lg border border-border/70';

export const badge =
  'inline-flex items-center gap-1 rounded-md border border-border/60 bg-black/50 px-2 py-0.5 text-[10px]';

export const headerBar =
  'sticky top-0 z-10 mb-2 flex items-center justify-between rounded-lg border border-border bg-black/60 px-2 py-1';
