...
export default function SimulationPage() {
  ...
  const run = () => {
    try {
      ...
      const res = window.HeICSim?.simulate ? window.HeICSim.simulate({ name:'Player', stats:{ hp:10, atk:0, armor:0, speed:0 } }, { name:'Opponent', stats:{ hp:10, atk:0, armor:0, speed:0 } }, { maxTurns: 1 }) : null;
      setResult(res);
    } catch (e: any) {
